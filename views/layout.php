...
<body>
            ...
            <?php if ($atrasos) { ?>
                <form id="buscador">
                    <div class="buscadooor">
                        ...
                        <input class="input__busc" type="number" placeholder="ID de Atraso" id="id">
                    </div>
                    <div class="buscadooor">
                    ...
                    <div class="buscadooor">
                        <label class="titulo__busc" for="fecha">Fecha Atraso</label>
                        <input class="input__busc" type="text" placeholder="EJ: 06/04 (mes/dia) / 08 (mes)" id="fecha">
                    </div>
                    <div class="buscadooor">
                        <label class="titulo__busc" for="horaMin">Hora Min Atraso</label>
                        <input class="input__busc" type="text" placeholder="EJ: 08:40" id="horaMin">
                    </div>
                    <div class="buscadooor">
                        <label class="titulo__busc" for="horaMax">Hora Max Atraso</label>
    ...
    <nav id="mySidenav" class="sidenav">
        ...
        <?php if ($_SESSION['admin'] == '1') { ?>
            <button class="bm" onclick="document.getElementById('modal').showModal();">Agregar Atraso</button>
            <dialog id="modal">
                <form class="form" action="/admin/atraso/crear" method="POST">
                    <legend class="tittle"> Agregar Atraso</legend>
                    <!-- CAMPOS -->
                    <div class="cont-campos">
                        <h5>Rut Estudiante:</h5>
                        <input type="text" class="text-area"
                                id="rut_estu" list="listaEstudiantes"
                                name="atraso[rut_estu]"
                    ...
                    <div class="cont-campos">
                        <h5>Comentario:</h5>
                        <input class="text-area" type="text" id="comentario_atr" name="atraso[comentario_atr]" placeholder="Intento de Fuga (Opcional)">
                    </div>
        ...
        <?php } else if ($_SESSION['admin'] === '0') { ?>
            ...
            <dialog id="modal">
                <form class="form" action="/admin/atraso/crear" method="POST">
                    ...
                    <div class="cont-campos">
                        <h5> Rut estudiante:</h5>
                        <input class="text-area" type="text" id="rut_estu" name="atraso[rut_estu]" placeholder="12345678-9">
                    </div>
                    <input type="hidden" value="<?php echo $_SESSION['usuario']; ?>" name="atraso[rut_func]">
